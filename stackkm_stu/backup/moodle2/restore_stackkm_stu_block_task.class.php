...
/**
 * The task that provides a complete restore of block_stackkm_stu is defined here.
 *
...
require_once($CFG->dirroot.'//blocks/stackkm_stu/backup/moodle2/restore_stackkm_stu_stepslib.php');

/**
 * Restore task for block_stackkm_stu.
 */
class restore_stackkm_stu_block_task extends restore_block_task {
