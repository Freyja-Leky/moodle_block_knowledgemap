...
require_once($CFG->dirroot.'//blocks/stackkm_stu/backup/moodle2/backup_stackkm_stu_stepslib.php');

/**
 * Provides all the settings and steps to perform a complete backup of block_stackkm_stu.
 */
class backup_stackkm_stu_block_task extends backup_block_task {
